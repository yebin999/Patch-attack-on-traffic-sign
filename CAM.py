...
if __name__ == '__main__':
    ...
    args.gpu = True
    args.b = 1
    args.root = "/data/user1/yebin/work/Data_lib/CAM/VGG16/image_patch"
    args.visual_heatmap = True
    img_path = "/data/user1/yebin/work/Data_lib/CAM/VGG16/image_patch/0_adImg.png"
    save_path = "/data/user1/yebin/work/Data_lib/CAM/VGG16/heatmap:"
    ...
    for n_iter, (image, label) in enumerate(cifar100_test_loader):
        ...
        feature_flatten = features.view(features.size()[0], -1)
        output = net.classifier(feature_flatten)
        print("")
