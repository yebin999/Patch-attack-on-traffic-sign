...
if __name__ == '__main__':
    ...
    args.gpu = True
    args.b = 1
    args.root = "/data/user1/yebin/work/Data_lib/CAM/ResNet34/image_patch"
    args.visual_heatmap = True
    img_path = "/data/user1/yebin/work/Data_lib/CAM/ResNet34/image_patch/0_adImg.png"
    save_path = "/data/user1/yebin/work/Data_lib/CAM/ResNet34/heatmap/"
    ...
    for n_iter, (image, label) in enumerate(cifar100_test_loader):
        ...
        output = net.conv2_x(output)
        output = net.conv3_x(output)
        output = net.conv4_x(output)
        features = net.conv5_x(output)
        print("feature.shape:", features.shape)
        features1 = net.avg_pool(features)
        feature_flatten = features1.view(features1.size(0), -1)
        output = net.fc(feature_flatten)
        print("")
        ...
        # 最后一层feature的通道数
        for i in range(512):  # TODO 这步好像有问题
